    ...
    for line in rdr:
        if index <= 2:
            ...
            if data.get('college'):
                ...
                requests.post(url="http://127.0.0.1:8000/api/v1/college/", data=data)
            if data.get('department'):  
                data['name'] = data['department']
                requests.post(url="http://127.0.0.1:8000/api/v1/department/", data=data)
...
#f("강좌검색 (2).csv", 2021, 1)
#f("강좌검색 (4).csv", 2020, 2)
list_ = [("강좌검색.csv", 2022, 1),("강좌검색 (1).csv", 2021, 2), ("강좌검색 (2).csv", 2021, 1),("강좌검색 (4).csv", 2020, 2), ("강좌검색 (5).csv", 2020, 1), ("강좌검색 (6).csv", 2019, 2), ("강좌검색 (7).csv", 2019, 1), ("강좌검색 (8).csv", 2018, 2), ("강좌검색 (9).csv", 2018, 1)]
for i in list_:
    if not f(*i):
        break
